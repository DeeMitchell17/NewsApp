...
public final class QueryUtils {
    ...
    /**
     * Query the Guardian dataset and return a list of Movie objects.
     */
    ...
    private static List<Movie> extractFeatureFromJson(String movieJSON) {
        ...
        // Create an empty ArrayList that we can start adding news movies to
        ...
        try {
            ...
            for (int i = 0; i < movieArray.length(); i++) {
                ...
                String sectionName = currentMovie.getString("sectionName");
                ...
                movies = new Movie(title, sectionName, publicationDate, url, authorName);
